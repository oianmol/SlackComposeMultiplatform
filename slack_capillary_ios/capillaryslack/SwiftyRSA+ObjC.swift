...
public class _objc_SwiftyRSA: NSObject { // swiftlint:disable:this type_name
    ...
    @objc public class func generateRSAKeyPair(sizeInBits size: Int,chainId:String) throws -> _objc_KeyPair {
        let (privateKey, publicKey) = try SwiftyRSA.generateRSAKeyPair(sizeInBits: size,chainId:chainId)
